...
import { DECORATION_GARLAND, DECORATION_WREATH, ICON_AUTOMATION, ICON_ELVES_BENCH, ICON_EVERGREEN_ESSENCE, ICON_FERTILIZED_SOIL, ICON_FIREPLACE, ICON_GREENHOUSE_EXTENSION, ICON_AXE, ICON_HOLIDAY_BELL, ICON_HOLIDAY_REGISTER, ICON_ORNAMENT_WORKBENCH, ICON_STAR_FORGE, ICON_TRADITIONAL_ORNAMENT, TREE_FIR, TREE_PINE, TREE_SAPLING, TREE_SPRUCE } from '../config/assetPaths';
import type {
  TreeQuality,
  DecorationType,
  CraftingRecipe,
