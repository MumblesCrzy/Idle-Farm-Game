...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  ...
  },
  {
    ...
    inputs: {
      // Placeholder - will need crops from main game
      wood: 1,
    },
    output: {
      ornaments: 2,
...
export const FARMING_UPGRADES: EventUpgrade[] = [
  ...
  },
  {
    ...
    cost: 400,
    owned: false,
    effect: '+25% tree growth speed',
    speedBonus: 0.25,
  },
  {
    id: 'greenhouse_extension',
    name: 'Greenhouse Extension',
    description: 'Protect trees from harsh winter storms',
    category: 'farming',
    cost: 750,
    owned: false,
    effect: 'Trees unaffected by snowstorms',
  },
  {
...
export const WORKSHOP_UPGRADES: EventUpgrade[] = [
  ...
  },
  {
    ...
    description: 'Enchanted lights that enhance tree quality',
    category: 'workshop',
    cost: 2000,
    owned: false,
    effect: '10% chance to create Luxury Tree',
    procChance: 0.10,
  },
  {
    id: 'star_forge',
